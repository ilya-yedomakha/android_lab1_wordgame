...
public class GameActivity extends AppCompatActivity {
    ...
    public static final String TOP_BUTTONS_TEXT = "TIMER_MINUTES";
    ...
    public ArrayList<String> normal_words = new ArrayList<>(Arrays.asList("мама",
            "тато",
            "сонце",
            "радіо",
            "фото",
    ...
    public ArrayList<String> hard_words = new ArrayList<>(Arrays.asList("горизонт",
            "завдання",
            "календар",
            "магістр",
            "розповідь",
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            timer_minutes = intent.getIntExtra(TIMER_MINUTES, 2);
        }
        initializeOnCreate();
        if (savedInstanceState != null) {
            difficulty = savedInstanceState.getInt(DIFFICULTY);
            timer_minutes = savedInstanceState.getInt(TIMER_MINUTES);
            word = savedInstanceState.getString(WORD);
            normal_words.clear();
            normal_words.addAll(savedInstanceState.getStringArrayList(NORMAL_WORDS));
            hard_words.clear();
            hard_words.addAll(savedInstanceState.getStringArrayList(HARD_WORDS));
            topButtonsText.clear();
            topButtonsText.addAll(savedInstanceState.getStringArrayList(TOP_BUTTONS_TEXT));
            bottomButtonsText.clear();
            bottomButtonsText.addAll(savedInstanceState.getStringArrayList(BOTTOM_BUTTONS_TEXT));
            guessed_words.clear();
            guessed_words.addAll(savedInstanceState.getStringArrayList(GUESSED_WORDS));
            timeRemaining = savedInstanceState.getLong(TIMER_STATE);

            ArrayList<Integer> topIndexes = new ArrayList<>();
            topIndexes.addAll(savedInstanceState.getIntegerArrayList(TOP_INDEXES));

            ArrayList<Integer> bottomIndexes = new ArrayList<>();
            bottomIndexes.addAll(savedInstanceState.getIntegerArrayList(BOTTOM_INDEXES));
            top_bottom_switch.clear();
            for (int i = 0; i < bottomIndexes.size(); i++) {
                top_bottom_switch.put(topIndexes.get(i), bottomIndexes.get(i));
            }
            words_done = savedInstanceState.getBoolean(ALL_WORDS_DONE);
            timer_finished = savedInstanceState.getBoolean(TIMER_FINISHED);
        ...
        bottomButton.setOnClickListener(view -> {
            ...
            if (cleanWord.length() == word.length()) {
                if (cleanWord.toString().equals(word)) {
                    ...
                    Toast.makeText(this, "Word is incorrect!", Toast.LENGTH_SHORT).show();
                }
            }
    ...
    private void initializeOnCreate() {
        ...
        textView = findViewById(R.id.testTextWord);
        topButton1 = findViewById(R.id.topButton1);
        topButton2 = findViewById(R.id.topButton2);
        topButton3 = findViewById(R.id.topButton3);
        topButton4 = findViewById(R.id.topButton4);
        topButton5 = findViewById(R.id.topButton5);
        topButton6 = findViewById(R.id.topButton6);
        topButton7 = findViewById(R.id.topButton7);
        topButton8 = findViewById(R.id.topButton8);
        topButton9 = findViewById(R.id.topButton9);
        ...
        bottomButton4 = findViewById(R.id.bottomButton4);
        bottomButton5 = findViewById(R.id.bottomButton5);
        bottomButton6 = findViewById(R.id.bottomButton6);
        bottomButton7 = findViewById(R.id.bottomButton7);
        bottomButton8 = findViewById(R.id.bottomButton8);
        bottomButton9 = findViewById(R.id.bottomButton9);
